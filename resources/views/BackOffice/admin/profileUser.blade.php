                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="../upload/user_images/{{ $userProfile->profile_photo_path }}" alt="picture of {{ $userProfile->last_name }}" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                                    <h4>{{ $userProfile->first_name }} {{ $userProfile->last_name }}</h4>
                                    <p class="text-secondary mb-1">{{ $userProfile->post_description }}</p>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mb-5">More information</h4>
                                    ...
                                    <div  class="d-flex">
                                        <h6>Gender : </h6>
                                        <div class="mx-3">
                                            @if($userProfile->gender)<p>{{ $userProfile->gender }}</p>@else <p>&emsp; inconnu</p>
                                            @endif
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="mx-3">
                                            @if($userProfile->post_description)<p>{{ $userProfile->post_description }}</p>@else <p>&emsp; inconnu</p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="mx-3">
                                            @if($userProfile->email)<p class=" ">{{ $userProfile->email }}</p>@else <p>&emsp; inconnu</p>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="mx-3">
                                            @if($userProfile->phone)<p class=" ">{{ $userProfile->phone }}</p>@else <p>&emsp; inconnu</p>
                                            @endif
                                        </div>
                                    </div>
