            ...
            <div class="card radius-10 border-start border-0 border-3 border-info">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Total prepaid balance
                            </p>
                            <h4 class="my-1 text-info">{{ $sum_balance }} Fcfa</h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1 text-info">{{ $balance  }} Fcfa</h4>
                            <p class="mb-0 font-13"></p>
                        </div>
                        <div class="widgets-icons-2 rounded-circle bg-gradient-scooter text-white ms-auto"><i class='bx bxs-cart'></i>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1 text-danger">{{ $sum_expense }} Fcfa</h4>
                            <p class="mb-0 font-13"></p>
                        </div>
        ...
        <div class="col">
            <div class="card radius-10 border-start border-0 border-3 border-success">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <p class="mb-0 text-secondary">Trainnings</p>
                            <h4 class="my-1 text-success">{{ $sum_trainning }}</h4>
                            <p class="mb-0 font-13"></p>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1 text-warning">{{ $sum_student }}</h4>
                            <p class="mb-0 font-13"></p>
                        </div>
