                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-info">Complet payment</h5>
                        </div>
                        <hr />
                        <form action="{{ route('payment.add') }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="amount_pay" class="form-control" id="last_name" placeholder="Doe" value="{{ isset($data_trainning->amount) ? $data_trainning->amount : ''}}">
                                </div>
                            </div>
                            <div class="row">
